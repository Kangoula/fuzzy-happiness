...
import fr.miage.bibaldenis.repository.UsagerRepository;
...
public class UsagerResource {
    ...
    @Timed
    public ResponseEntity<Usager> createUsager(@RequestBody Usager usager) throws URISyntaxException {
    ...
    @RequestMapping(value = "/usagers",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Usager> updateUsager(@RequestBody Usager usager) throws URISyntaxException {
